...
pub async fn setup_container(
    ...
    // Set up host config for the container
    let host_cfg = HostConfig {
        binds: Some(vec![
            format!("{}:/src:ro", project_path.display()),  // Mount project as read-only
    ...
    let container_config = Config {
        ...
        working_dir: Some("/flake-dir".to_string()),
